...
class UserFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'national_code' => $this->randomCountryCode(),
            'gender' => fake()->boolean(),
            'image_path' => '/users-image/default-user-image.jpg',
    ...
    public function randomCountryCode()
    {
        $countries = [
        ...
        return str_replace('+', '', $countries[array_rand($countries, 1)]['dial_code']);
    }
}
